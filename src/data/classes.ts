...
export const CLASSES: ClassDefinition[] = [
  ...
  },
  {
    ...
    educacion: {
      ...
      habilidades: [
        { habilidad: 'academia', valor: 1, alternativas: ['oficios'] },
      ...
      beneficiosDeClase: [
        'Agilidad', 'Alentar', 'Armonizar', 'Artes Marciales',
        'Cartulario', 'Caza de Brujas', 'Condenar', 'Hierofante',
        'Iluminado', 'Inspirador', 'Inviolabilidad', 'Legado',
        'Ordenación Religiosa', 'Pastor del Rebaño', 'Purga',
        'Riqueza', 'Sabio', 'Sello Inquisitorial', 'Sermón Virtuoso',
        'Sirviente', 'Súplica', 'Terrateniente',
      ],
    },
  },
  {
    ...
    educacion: {
      ...
      beneficiosDeClase: [
        'Agilidad', 'Artes Marciales', 'Bendición del Santo', 'Cargo Gremial',
        'Embargo', 'Experto en Tecnología', 'Ingenioso', 'Manitas',
        'Puntería', 'Riqueza', 'Sirviente', 'Tahúr', 'Terrateniente',
      ],
    },
  },
  {
    ...
    educacion: {
      ...
      competenciasLibres: 2,
      caracteristicas: [],
      caracteristicasLibres: 5,
      habilidades: [],
      habilidadesLibres: 5,
      beneficioArquetipico: 'Autónomo',
      beneficiosDeClase: [
        'Adjunto de Casa', 'Agilidad', 'Artes Marciales', 'Autónomo',
        'Bendición del Santo', 'Héroe del Pueblo', 'Rango Militar',
        'Reputación Profesional',
      ],
      beneficiosDeCualquierClase: true,
    },
  },
]
